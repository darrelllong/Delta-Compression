...
**1 MB — 2,000 blocks × 512 B mean (greedy, onepass, correcting)**

| Algorithm | Perm% | Ratio | Copies | Adds | Time |
|-----------|------:|------:|-------:|-----:|-----:|
| greedy | 0% | 0.0000 | 1 | 0 | 0.111s |
| greedy | 25% | 0.0111 | 869 | 0 | 0.106s |
| greedy | 50% | 0.0191 | 1,498 | 0 | 0.111s |
| greedy | 75% | 0.0239 | 1,877 | 0 | 0.117s |
| greedy | 100% | 0.0255 | 1,999 | 0 | 0.111s |
| onepass | 0% | 0.0000 | 1 | 0 | 0.004s |
| onepass | 25% | 0.2545 | 373 | 371 | 0.015s |
| onepass | 50% | 0.5046 | 503 | 502 | 0.025s |
| onepass | 75% | 0.7542 | 381 | 382 | 0.035s |
| onepass | 100% | 0.9632 | 75 | 75 | 0.051s |
| correcting | 0% | 0.0000 | 1 | 0 | 0.017s |
| correcting | 25% | 0.0111 | 869 | 0 | 0.017s |
| correcting | 50% | 0.0191 | 1,498 | 0 | 0.017s |
| correcting | 75% | 0.0239 | 1,877 | 0 | 0.017s |
| correcting | 100% | 0.0255 | 1,999 | 0 | 0.017s |

**128 MB — 1,000,000 blocks × 128 B mean (onepass, correcting)**

| Algorithm | Perm% | Ratio | Copies | Adds | Time |
|-----------|------:|------:|-------:|-----:|-----:|
| onepass | 0% | 0.0000 | 1 | 0 | 0.062s |
| onepass | 25% | 0.2821 | 187,376 | 187,377 | 1.615s |
| onepass | 50% | 0.5429 | 249,817 | 249,818 | 3.061s |
| onepass | 75% | 0.7823 | 187,786 | 187,784 | 4.347s |
| onepass | 100% | 0.9988 | 1,474 | 1,474 | 7.033s |
| correcting | 0% | 0.0000 | 1 | 0 | 1.049s |
| correcting | 25% | 0.0473 | 432,800 | 4,544 | 1.224s |
| correcting | 50% | 0.0820 | 740,563 | 9,144 | 1.363s |
| correcting | 75% | 0.1037 | 924,263 | 13,312 | 1.454s |
| correcting | 100% | 0.1111 | 984,748 | 14,986 | 1.499s |

correcting matches greedy exactly at every permutation level: zero adds,
same copy count, same ratio.  onepass degrades sharply — at 100%
permutation it produces a ratio of 0.9632 (1 MB) and 0.9988 (128 MB),
nearly identical to the input size.  correcting is 4× slower than
onepass at 0% but only 1.4× slower at 100%, where onepass spends most
of its time emitting add commands.
