...
inline constexpr uint8_t DELTA_MAGIC[4] = {'D', 'L', 'T', 0x02};
...
inline constexpr size_t  DELTA_HASH_SIZE = 16;   // SHAKE128(16) digest
inline constexpr size_t  DELTA_HEADER_SIZE = 41; // magic(4) + flags(1) + version_size(4) + src_hash(16) + dst_hash(16)
